    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-foreground/50">Sign in to your account to continue</p>
        </div>
        ...
        <div className="rounded-card border border-border bg-surface p-8 shadow-sm">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="flex items-center justify-end">
              <Link to="/forgot-password" className="text-sm font-medium text-accent hover:text-accent/80 transition-colors cursor-pointer">
                Forgot password?
              </Link>
            </div>
        ...
        <p className="mt-6 text-center text-sm text-foreground/50">
          ...
          <Link to="/signup" className="font-semibold text-accent hover:text-accent/80 transition-colors cursor-pointer">
            Sign Up
          </Link>
        </p>
      </div>
